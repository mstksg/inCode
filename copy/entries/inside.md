...
<!-- <1!-- The semantics work in that the new `State s b` is a new state-modifying --1> -->
<!-- <1!-- machine.  It takes an input of type `s`, feeds it into the first machine, --1> -->
