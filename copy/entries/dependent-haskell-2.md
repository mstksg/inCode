...
Where the case statement pattern match represented the lexical
"wall"/"boundary" between the untyped and typed world for the constructor
style, that `... $ \n -> ...` can be thought of the "wall" for the existential
style.
