...
of the Functor that gives us naturality for `forall a. [a] -> Int`?[^3]
...
[^1]: Excluding `unsafePerformIO`, `unsafeCoerce`, etc.

[^2]: If you disallow `repeat`, `forall a. a -> [a]` is actually isomorphic to
    the natural numbers!

[^3]: It's `forall a. [a] -> Const Int a`!
