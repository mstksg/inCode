...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={Faking GADTs in Languages That Shouldn't Have Them},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\title{Faking GADTs in Languages That Shouldn't Have Them}
...
\textbf{\href{https://blog.jle.im/entry/faking-gadts-in-languages-that-shouldnt-have-them.html}{in
Code}}.}
...
into supporting them) might not support GADTs. Unless \ldots{}
