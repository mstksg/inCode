...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={Justin Le},
            pdftitle={Extreme Types: Dependently Typed Tic Tac Toe (Part 1)},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\title{Extreme Types: Dependently Typed Tic Tac Toe (Part 1)}
\author{Justin Le}
...
\textbf{\href{https://blog.jle.im/entry/extreme-types-dependently-typed-tic-tac-toe-1.html}{in
Code}}.}
