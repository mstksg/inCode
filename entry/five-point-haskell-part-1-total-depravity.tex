...
Haskell}}, let's set out to establish a five-point framework for typed
...
delusion to fall into, if you don't believe in total depravity.
However\ldots sooner or later (maybe in a week, maybe in a year, maybe after you
onboard that new team member)\ldots someone is going to accidentally pass a site
ID where an app ID is expected.
...
Returning \texttt{Maybe} or optional forces the caller to handle:
