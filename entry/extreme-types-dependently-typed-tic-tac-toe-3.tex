...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={Justin Le},
            pdftitle={Extreme Types: Dependently Typed Tic Tac Toe (Part 3)},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\title{Extreme Types: Dependently Typed Tic Tac Toe (Part 3)}
\author{Justin Le}
...
\textbf{\href{https://blog.jle.im/entry/extreme-types-dependently-typed-tic-tac-toe-3.html}{in
Code}}.}
