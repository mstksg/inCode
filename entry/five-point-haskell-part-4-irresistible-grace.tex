...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={Justin Le},
            pdftitle={``Five Point Haskell'' Part 4: Irresistible Grace},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\title{``Five Point Haskell'' Part 4: Irresistible Grace}
\author{Justin Le}
...
\textbf{\href{https://blog.jle.im/entry/five-point-haskell-part-4-irresistible-grace.html}{in
Code}}.}
