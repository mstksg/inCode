...
This is a good plan of action for languages like javascript (without
typescript), or python without types.
...
([source here](https://github.com/mstksg/corona-charts/tree/master)) in
purescript. I needed a singleton to represent *scales* for scatter plots and
