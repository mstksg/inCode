...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{/img/entries/path-integral-intro/potential3d.png}}
\caption{An example of a 2D potential \(U(\vec{r})\).}
\end{figure}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{/img/entries/path-integral-intro/gradient.png}}
