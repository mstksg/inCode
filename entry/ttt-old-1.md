...
> [Read online!](https://blog.jle.im/entry/ttt-old-1.html)
...
``` haskell
-- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L54-L56
...
``` haskell
-- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L58-L58
...
``` haskell
-- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L73-L73
...
``` haskell
-- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L60-L71
...
``` haskell
-- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L87-L87
...
``` haskell
-- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L73-L78
...
``` haskell
-- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L80-L80
...
``` haskell
-- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L80-L85
...
``` haskell
-- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L87-L92
...
``` haskell
-- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L94-L100
...
-- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L108-L118
...
``` haskell
-- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L102-L103
...
``` haskell
-- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L165-L167
...
``` haskell
-- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L169-L171
...
code](https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs)
...
``` haskell
-- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L120-L155
...
1.  For the first branch, we have `'Z` and `'[]`. This should be false, because
    ...
    *-XLambdaCase* extension):
    ...
    ``` haskell
    -- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L132-L134
    ...
    ``` haskell
    -- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L136-L138
...
2.  For the second branch, we have `'Z` and `(x ': xs)`. We want to prove that
    ...
    *yes*, there does, and that item is `x`, and the `Sel` is `SelZ`!
    ...
    ``` haskell
    -- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L140-L144
...
3.  For the third branch, we have `'S n` and `'[]`. Again, this should be false,
    ...
    ``` haskell
    -- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L146-L149
...
4.  The fourth branch is the most interesting one. We have `'S n` and
    ...
    ``` haskell
    -- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L151-L163
...
-- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L105-L105
...
``` haskell
-- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L173-L190
...
``` haskell
-- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L192-L211
...
``` haskell
-- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L218-L242
...
``` haskell
-- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt-old/Part1.hs#L213-L216
