...
libraries\footnote{It is a well established fact that Haskellers are addicted to
  writing libraries.} and years later you re-implement them after forgetting
that you wrote them. And the other day I just realized that that's exactly what
happened here --- I actually wrote a whole
