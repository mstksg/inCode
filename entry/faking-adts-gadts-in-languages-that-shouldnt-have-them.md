...
Let's get normal ADT's out of the way. Most languages do have *structs*. Not all
languages have *immutable* structs, but we'll take what we can get. With
...
I'm going to use C++ *without classes* or the stdlib (using only raw function
