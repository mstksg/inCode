...
very simple numerical soft-body physics simulation[^1] in a language of their
choice, the solution just has to be functional in nature.
...
re-implement them after forgetting that you wrote them. And the other day I just
realized that that's exactly what happened here --- I actually wrote a whole
[blog post series](https://blog.jle.im/entries/series/+hamilton.html) on the
