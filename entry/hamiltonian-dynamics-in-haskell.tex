...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{/img/entries/hamilton/contour-lines.jpg}}
...
If we have a function from a sized vector to a scalar, we can use \texttt{grad}
to get its gradient:
