...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={Justin Le},
            pdftitle={Extreme Haskell: Typed State Machines with Typed Lambda Calculus (Part 3)},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\title{Extreme Haskell: Typed State Machines with Typed Lambda Calculus (Part
3)}
\author{Justin Le}
...
\textbf{\href{https://blog.jle.im/entry/extreme-haskell-typed-state-machines-javascript-compiler.html}{in
Code}}.}
