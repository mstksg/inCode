...
\subsection{The Case for Purity}\label{the-case-for-purity}
...
\href{https://journal.stuffwithstuff.com/2015/02/01/what-color-is-your-function/}{function
color debate}. Sneaking in IO in a deeply nested function requires completely
...
All of the above should show you that we get \emph{some} value out of
delineating pure from impure code. But what might that delineation look like?

Based on
\href{https://journal.stuffwithstuff.com/2015/02/01/what-color-is-your-function/}{function-color
semantics}, we could create an opt-in system simply where we agree that all
functions that ``do IO'' are wrapped in some sort of type constructor. A
\texttt{String} is a pure string, which does no IO in the process of evaluating
or using it. But an \texttt{IO\ String} is an IO action that produces a string.

In Haskell, this \texttt{IO} type is the ``grab bag'' where we throw pretty much
everything
...
interface. Here's a minimal ``IO'' type that only does work when you
\texttt{run} it:
...
\KeywordTok{template} \OperatorTok{\textless{}}\KeywordTok{class}\NormalTok{ A}\OperatorTok{\textgreater{}}
\KeywordTok{class}\NormalTok{ IO }\OperatorTok{\{}
  \BuiltInTok{std::}\NormalTok{function}\OperatorTok{\textless{}}\NormalTok{A}\OperatorTok{()\textgreater{}}\NormalTok{ action}\OperatorTok{;}

\KeywordTok{public}\OperatorTok{:}
  \KeywordTok{explicit}\NormalTok{ IO}\OperatorTok{(}\BuiltInTok{std::}\NormalTok{function}\OperatorTok{\textless{}}\NormalTok{A}\OperatorTok{()\textgreater{}}\NormalTok{ a}\OperatorTok{)} \OperatorTok{:}\NormalTok{ action}\OperatorTok{(}\BuiltInTok{std::}\NormalTok{move}\OperatorTok{(}\NormalTok{a}\OperatorTok{))} \OperatorTok{\{\}}

\NormalTok{  A run}\OperatorTok{()} \AttributeTok{const} \OperatorTok{\{} \ControlFlowTok{return}\NormalTok{ action}\OperatorTok{();} \OperatorTok{\}}

  \KeywordTok{template} \OperatorTok{\textless{}}\KeywordTok{class}\NormalTok{ B}\OperatorTok{\textgreater{}}
\NormalTok{  IO}\OperatorTok{\textless{}}\NormalTok{B}\OperatorTok{\textgreater{}}\NormalTok{ map}\OperatorTok{(}\BuiltInTok{std::}\NormalTok{function}\OperatorTok{\textless{}}\NormalTok{B}\OperatorTok{(}\NormalTok{A}\OperatorTok{)\textgreater{}}\NormalTok{ f}\OperatorTok{)} \AttributeTok{const} \OperatorTok{\{}
    \ControlFlowTok{return}\NormalTok{ IO}\OperatorTok{\textless{}}\NormalTok{B}\OperatorTok{\textgreater{}([=]} \OperatorTok{\{} \ControlFlowTok{return}\NormalTok{ f}\OperatorTok{(}\NormalTok{run}\OperatorTok{());} \OperatorTok{\});}
  \OperatorTok{\}}

  \KeywordTok{template} \OperatorTok{\textless{}}\KeywordTok{class}\NormalTok{ B}\OperatorTok{\textgreater{}}
\NormalTok{  IO}\OperatorTok{\textless{}}\NormalTok{B}\OperatorTok{\textgreater{}}\NormalTok{ flatMap}\OperatorTok{(}\BuiltInTok{std::}\NormalTok{function}\OperatorTok{\textless{}}\NormalTok{IO}\OperatorTok{\textless{}}\NormalTok{B}\OperatorTok{\textgreater{}(}\NormalTok{A}\OperatorTok{)\textgreater{}}\NormalTok{ f}\OperatorTok{)} \AttributeTok{const} \OperatorTok{\{}
    \ControlFlowTok{return}\NormalTok{ IO}\OperatorTok{\textless{}}\NormalTok{B}\OperatorTok{\textgreater{}([=]} \OperatorTok{\{} \ControlFlowTok{return}\NormalTok{ f}\OperatorTok{(}\NormalTok{run}\OperatorTok{()).}\NormalTok{run}\OperatorTok{();} \OperatorTok{\});}
  \OperatorTok{\}}
\OperatorTok{\};}

\NormalTok{IO}\OperatorTok{\textless{}}\BuiltInTok{std::}\NormalTok{string}\OperatorTok{\textgreater{}}\NormalTok{ readLine}\OperatorTok{()} \OperatorTok{\{}
  \ControlFlowTok{return}\NormalTok{ IO}\OperatorTok{\textless{}}\BuiltInTok{std::}\NormalTok{string}\OperatorTok{\textgreater{}([]} \OperatorTok{\{}
    \BuiltInTok{std::}\NormalTok{string s}\OperatorTok{;}
    \BuiltInTok{std::}\NormalTok{getline}\OperatorTok{(}\BuiltInTok{std::}\NormalTok{cin}\OperatorTok{,}\NormalTok{ s}\OperatorTok{);}
    \ControlFlowTok{return}\NormalTok{ s}\OperatorTok{;}
  \OperatorTok{\});}
\OperatorTok{\}}

\NormalTok{IO}\OperatorTok{\textless{}}\DataTypeTok{void}\OperatorTok{\textgreater{}}\NormalTok{ putLine}\OperatorTok{(}\AttributeTok{const} \BuiltInTok{std::}\NormalTok{string}\OperatorTok{\&}\NormalTok{ s}\OperatorTok{)} \OperatorTok{\{}
  \ControlFlowTok{return}\NormalTok{ IO}\OperatorTok{\textless{}}\DataTypeTok{void}\OperatorTok{\textgreater{}([=]} \OperatorTok{\{}
    \BuiltInTok{std::}\NormalTok{cout }\OperatorTok{\textless{}\textless{}}\NormalTok{ s }\OperatorTok{\textless{}\textless{}} \StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\OperatorTok{;}
  \OperatorTok{\});}
\OperatorTok{\}}

\NormalTok{IO}\OperatorTok{\textless{}}\DataTypeTok{void}\OperatorTok{\textgreater{}}\NormalTok{ program}\OperatorTok{()} \OperatorTok{\{}
  \ControlFlowTok{return}\NormalTok{ readLine}\OperatorTok{().}\NormalTok{flatMap}\OperatorTok{([](}\BuiltInTok{std::}\NormalTok{string name}\OperatorTok{)} \OperatorTok{\{}
    \ControlFlowTok{return}\NormalTok{ putLine}\OperatorTok{(}\StringTok{"hello "} \OperatorTok{+}\NormalTok{ name}\OperatorTok{);}
  \OperatorTok{\});}
\OperatorTok{\}}
\end{Highlighting}
\end{Shaded}
